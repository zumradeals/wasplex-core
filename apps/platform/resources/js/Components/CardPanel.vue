                ...
                <template v-else-if="card">
                    <section class="from-wpx-navy-700 via-wpx-navy-850 to-wpx-navy-950 border-wpx-gold/25 relative overflow-hidden rounded-[26px] border bg-gradient-to-br p-5 shadow-2xl">
                        ...
                        <div class="relative mt-10">
                            ...
                            <p class="text-wpx-gold mt-4 break-all font-mono text-sm tracking-[0.08em]">{{ card.public_identifier }}</p>
                        </div>
                    ...
                    <section class="border-wpx-border-dark bg-wpx-navy-850 mt-4 rounded-2xl border p-4">
                        ...
                        <p class="text-wpx-muted-dark mt-1.5 text-xs leading-relaxed">Votre QR ne révèle ni téléphone, ni e-mail, ni solde Wallet, ni KYC, ni données Santé ou Fonds. Il expire après 2 minutes et devient inutilisable après résolution.</p>
                    </section>

...
const pendingApprovals = computed(() => transactions.value.filter((transaction) => transaction.status === 'pending_approval').length);
...
<template>
    <div class="mx-auto flex max-w-5xl flex-col gap-5 text-wpx-white-soft">
        <section class="border-wpx-border-dark rounded-wpx-xl border bg-wpx-navy-850 p-5 shadow-wpx-card-dark">
            <p class="text-wpx-cyan text-[11px] font-extrabold uppercase tracking-[0.16em]">Audit & sécurité</p>
            <h2 class="mt-1 text-xl font-extrabold">Savoir si Wasplex est protégé.</h2>
            <p class="text-wpx-muted-dark mt-2 max-w-3xl text-sm">
                Cette vue résume les protections importantes. Les journaux d’audit détaillés seront ajoutés progressivement,
                sans supprimer les traces déjà conservées par les modules financiers et d’autorisation.
            </p>
        </section>
        ...
        <template v-else>
            <section class="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-4">
                <div class="border-wpx-border-dark rounded-wpx-lg border bg-wpx-navy-850 p-4 shadow-wpx-card-dark">
                    <p class="text-wpx-muted-dark text-[10px] font-extrabold uppercase tracking-wide">Infrastructure</p>
                ...
                <div class="border-wpx-border-dark rounded-wpx-lg border bg-wpx-navy-850 p-4 shadow-wpx-card-dark">
                    ...
                    <p class="mt-2 text-lg font-extrabold" :class="ledgerBalanced ? 'text-wpx-success' : 'text-wpx-danger'">
                        {{ ledgerBalanced ? 'Équilibré' : 'À vérifier' }}
                    </p>
                </div>
                <div class="border-wpx-border-dark rounded-wpx-lg border bg-wpx-navy-850 p-4 shadow-wpx-card-dark">
                    <p class="text-wpx-muted-dark text-[10px] font-extrabold uppercase tracking-wide">Accès administration</p>
                    <p class="mt-2 text-lg font-extrabold">{{ adminAccountsCount }}</p>
                    <p class="text-wpx-muted-dark mt-1 text-[11px]">comptes distincts</p>
                </div>
                <div class="border-wpx-border-dark rounded-wpx-lg border bg-wpx-navy-850 p-4 shadow-wpx-card-dark">
                    <p class="text-wpx-muted-dark text-[10px] font-extrabold uppercase tracking-wide">Double validation</p>
            ...
            <section class="border-wpx-border-dark rounded-wpx-xl border bg-wpx-navy-850 p-5 shadow-wpx-card-dark">
                ...
                <div class="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2">
                    ...
                    <div class="border-wpx-border-dark rounded-wpx-lg border bg-wpx-navy-950 p-4">
                        ...
                        <p class="text-wpx-muted-dark mt-1 text-xs">
                            Les corrections comptables passent par de nouvelles écritures plutôt que par la modification du passé.
                        </p>
                    </div>
                    <div class="border-wpx-border-dark rounded-wpx-lg border bg-wpx-navy-950 p-4">
                        <p class="text-wpx-success text-sm font-extrabold">✓ Accès par rôle</p>
                        <p class="text-wpx-muted-dark mt-1 text-xs">
                            Chaque administrateur utilise son propre compte et reçoit seulement les permissions nécessaires.
                        </p>
                    </div>
                    <div class="border-wpx-border-dark rounded-wpx-lg border bg-wpx-navy-950 p-4">
            ...
            <section class="border-wpx-border-dark rounded-wpx-xl border bg-wpx-navy-850 p-5 shadow-wpx-card-dark">
                <div class="flex items-start gap-3">
                    <span class="bg-wpx-blue/12 text-wpx-blue flex h-9 w-9 shrink-0 items-center justify-center rounded-wpx-md">i</span>
                    <div>
                        <h3 class="text-sm font-extrabold">Journal d’audit détaillé</h3>
                        <p class="text-wpx-muted-dark mt-1 text-xs">
                            L’écran de recherche chronologique complet est encore en préparation. En attendant, les modules
                            Finance, Publicité et Permissions conservent leurs propres références et traces d’action.
                        </p>
                    </div>
                </div>
            </section>
